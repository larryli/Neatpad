...
#define TextView_SetStyleBool(hwndTV, uStyle, fBoolean)                        \
    SendMessage((hwndTV), TXM_SETSTYLE, (WPARAM)(uStyle),                      \
                (LPARAM)(fBoolean ? uStyle : 0))
...
#define TextView_SetLineImage(hwndTV, nLineNo, nImageIdx)                      \
    SendMessage((hwndTV), TXM_SETLINEIMAGE, (WPARAM)(ULONG)(nLineNo),          \
                (LPARAM)(ULONG)nImageIdx)
...
#define MIXED_SYSCOL(COLOR_IDX1, COLOR_IDX2)                                   \
    (0xC0000000 | (COLOR_IDX2 << 8) | COLOR_IDX1)
#define MIXED_SYSCOL2(COLOR_IDX1, COLOR_IDX2)                                  \
    (0xE0000000 | (COLOR_IDX2 << 8) | COLOR_IDX1)
