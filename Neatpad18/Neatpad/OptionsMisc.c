...
//      Options\Notepad" REG_SZ "Debugger"="C:\path\Neatpad.exe"
//
//
//  www.catch22.net
//
...
BOOL ElevateToAdmin(HWND hwnd, BOOL fChecked1,
                    BOOL fChecked2) // TCHAR *szParams)
{
                                 ...
                                 LPARAM lParam)
{
    ...
    case WM_INITDIALOG:
        ...
        hShield = LoadImage(0, MAKEINTRESOURCE(106), IMAGE_ICON, 32, 32,
                            LR_CREATEDIBSECTION); // IDI_SHIELD));
        ...
        EnableDlgItem(hwnd, IDC_REPLACENOTEPAD,
                      (GetVersion() & 0x80000000) ? FALSE : TRUE);
        return TRUE;
