...
struct _CUSTCOL {
    ...
    {RGB(255, 255, 255), "Automatic"}, {RGB(0, 0, 0), "Black"},
    {RGB(255, 255, 255), "White"},     {RGB(128, 0, 0), "Maroon"},
    {RGB(0, 128, 0), "Dark Green"},    {RGB(128, 128, 0), "Olive"},
    {RGB(0, 0, 128), "Dark Blue"},     {RGB(128, 0, 128), "Purple"},
    {RGB(0, 128, 128), "Aquamarine"},  {RGB(196, 196, 196), "Light Grey"},
    {RGB(128, 128, 128), "Dark Grey"}, {RGB(255, 0, 0), "Red"},
    {RGB(0, 255, 0), "Green"},         {RGB(255, 255, 0), "Yellow"},
    {RGB(0, 0, 255), "Blue"},          {RGB(255, 0, 255), "Magenta"},
    {RGB(0, 255, 255), "Cyan"},
...
BOOL FontCombo_DrawItem(HWND hwnd, DRAWITEMSTRUCT *dis)
{
    ...
    if (fTrueType)
        DrawIconEx(dis->hDC, dis->rcItem.left + 2, dis->rcItem.top, g_hIcon1,
                   16, 16, 0, 0, DI_NORMAL);
...
LONG CALLBACK PreviewWndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_PAINT:
        ...
        DrawText(ps.hdc, "Sample Text", -1, &rect,
...
BOOL InitFontOptionsDlg(HWND hwnd)
{
    ...
    //
    g_hIcon1 = LoadImage(GetModuleHandle(0), MAKEINTRESOURCE(IDI_ICON2),
                         IMAGE_ICON, 16, 16, 0);
