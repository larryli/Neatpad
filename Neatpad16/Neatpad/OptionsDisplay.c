                                    ...
                                    LPARAM lParam)
{
    ...
    case WM_INITDIALOG:
        ...
        SendDlgItemMessage(hwnd, IDC_LONGLINEMODE, CB_ADDSTRING, 0,
                           (LPARAM) _T("No Highlighting"));
        SendDlgItemMessage(hwnd, IDC_LONGLINEMODE, CB_ADDSTRING, 0,
                           (LPARAM) _T("Highlight long lines"));

        SendDlgItemMessage(hwnd, IDC_LONGLINEMODE, CB_SETCURSEL, g_fLongLines,
                           0);
    ...
    case WM_NOTIFY:
        ...
        if (pshn->hdr.code == PSN_APPLY) {
            ...
            g_fLongLines =
                SendDlgItemMessage(hwnd, IDC_LONGLINEMODE, CB_GETCURSEL, 0, 0);
    ...
    case WM_COMMAND:
        ...
        case IDC_LONGLINEMODE:
            ...
            if (HIWORD(wParam) == CBN_SELCHANGE) {
                int idx = SendDlgItemMessage(hwnd, IDC_LONGLINEMODE,
                                             CB_GETCURSEL, 0, 0);
